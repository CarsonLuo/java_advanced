...
import com.carson.core.convert.ConversionService;
...
public class GenericConversionService implements ConversionService, ConverterRegistry {
    ...
    public <T> T convert(Object source, Class<T> targetType) {
        ...
        return targetType.cast(converter.convert(source, sourceType, targetType));
    }
    ...
    protected GenericConverter getConverter(Class<?> sourceType, Class<?> targetType) {
        ...
        for (Class<?> sourceCandidate : sourceCandidates) {
            for (Class<?> targetCandidate : targetCandidates) {
                var convertiblePair = new GenericConverter.ConvertiblePair(sourceCandidate, targetCandidate);
